...
$(function () {
  ...
  var form = {
    ...
    foundSelectedNumbers: function foundSelectedNumbers() {
  ...
  function setWinnNumbers(arr) {
    do {
      ...
      do {
        var newElement = getRandomInt(1, 21);
  ...
  function winnTemplate(arr, winnCount) {
    ...
    $('.modal__count').text("".concat(winnCount));
  }
  ...
  $('.modal').mouseup(function (e) {
    // отслеживаем событие клика по modal
